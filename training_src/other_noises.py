...
def get_random_irregular_mask(image, max_tamper_area, outdir='./output_img/', save=False):
    ...
    if image.shape[2] == 512:
        config_path = ['E:\phd//4\code\VINE//vine\src//training_src\config_mask//random_medium_512.yaml',
                        'E:\phd//4\code\VINE//vine\src//training_src\config_mask//random_thick_512.yaml',
                        'E:\phd//4\code\VINE//vine\src//training_src\config_mask//random_thin_512.yaml',]
    elif image.shape[2] == 256:
        config_path = ['E:\phd//4\code\VINE//vine\src//training_src\config_mask//random_medium_256.yaml',
                        'E:\phd//4\code\VINE//vine\src//training_src\config_mask//random_thick_256.yaml',
                        'E:\phd//4\code\VINE//vine\src//training_src\config_mask//random_thin_256.yaml',]
    else:
