...
def parse_args():
    ...
    parser.add_argument("--dataset_folder", default="E:\phd//4\code\VINE\dataset//clip-filtered-dataset", type=str)
    parser.add_argument("--val_folder", default="E:\phd//4\code\VINE\dataset\openimage//valid", type=str)
    ...
    parser.add_argument("--max_train_epochs", type=int, default=10)  #10000
    parser.add_argument("--max_train_steps", type=int, default=50000)  #14000000

    # args for the model
    parser.add_argument("--pretrained_model_name_or_path", default="E:\phd//4\code\VINE\stabilityaisd_turbo")
    ...
    parser.add_argument("--output_dir", type=str, default="E:\phd//4\code\VINE//vine\src\output//finetuning_porn", required=False)
    ...
    parser.add_argument("--validation_num_images", type=int, default=4, help="Number of images to use for validation. -1 to use all images.")
    ...
    ###'E:\phd//4\code\VINE//vine\src\output//finetuning_porn\checkpoint-246000'
    ...
    parser.add_argument('--l2_loss_ramp', type=int, default=10000)
    ...
    parser.add_argument('--rnd_trans_ramp', type=int, default=100)
    parser.add_argument('--rnd_bri_ramp', type=int, default=100)
    parser.add_argument('--rnd_sat_ramp', type=int, default=100)
    parser.add_argument('--rnd_hue_ramp', type=int, default=100)
    parser.add_argument('--rnd_noise_ramp', type=int, default=100)
    parser.add_argument('--contrast_ramp', type=int, default=100)
    parser.add_argument('--jpeg_quality_ramp', type=float, default=100)
    parser.add_argument('--no_im_loss_steps', help="Train without image loss for first x steps", type=int, default=100)
    ...
    parser.add_argument('--crop_resize_step', type=int, default=100) ##500000000
    parser.add_argument('--imagenetc_step', type=int, default=100)
    parser.add_argument('--resolution', type=int, default=256)
    parser.add_argument('--cuda', default= True)
    parser.add_argument('--checkpoint', type=str, default=None)
    parser.add_argument('--ic_up_level_interval', type=int, default=100)
    
    # Frequency domain regularization parameters
    parser.add_argument('--freq_loss_scale', type=float, default=0.5, help="Scale of frequency domain loss")
    parser.add_argument('--freq_constraint_start_step', type=int, default=5, help="Step to start frequency constraint")
    parser.add_argument('--lf_radius', type=int, default=10, help="Low frequency radius in pixels")
    parser.add_argument('--mf_radius', type=int, default=40, help="Mid frequency radius in pixels")
    parser.add_argument('--freq_energy_weight', type=float, default=1.0, help="Weight for frequency energy loss")
    parser.add_argument('--freq_smooth_weight', type=float, default=0.1, help="Weight for frequency smoothness loss")
