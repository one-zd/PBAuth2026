...
def edit_one_image_by_api(image_path, mask_path, prompt, output_path):
    ...
    try:
        ...
        print(f"[Info] Sending to Replicate API with prompt: '{prompt}'...")
        # Run Replicate API
...
if __name__ == '__main__':
    ...
    parser.add_argument("--image_path", type=str, default='E:\\phd\\4\\code\\VINE\\example\\api\\0_2328.png', help="Path to input image")
    parser.add_argument("--mask_path", type=str, default='E:\\phd\\4\\code\\VINE\\example\\api\\0_2328_mask.png', help="Path to input mask (optional)")
    ...
    parser.add_argument("--output_path", type=str, default='E:\\phd\\4\\code\\VINE\\example\\api\\0_2328_edited.png', help="Path to save output image")
